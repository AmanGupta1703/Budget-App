class UI {
  ...
  submitBudgetForm() {
    ...
    // if value is empty or negative, alert the user to not set an empty or a negative value
    if (value === "" || value < 0) {
      ...
      // if value is not empty then set the budgetAmount to value and clear the budget input field and call showBalance function
